...
Program will print some debug text, then it will print some nonsense line each second. You may stop canopend after few seconds with ctrl-c.
...
It seems CANopenNode started talking Linux.
