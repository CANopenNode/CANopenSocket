...
/*0x2130*/ const CO_OD_entryRecord_t OD_record2130[4] = {
           ...
           {(void*)&CO_OD_RAM.time.epochTimeOffsetMs, 0x8E,  4}};
...
/*0x2300*/ const CO_OD_entryRecord_t OD_record2300[9] = {
           ...
           {(void*)&CO_OD_ROM.traceConfig[0].printUnsigned, 0x0D,  1},
...
/*0x2400*/ const CO_OD_entryRecord_t OD_record2400[7] = {
           ...
           {(void*)&CO_OD_RAM.trace[0].size, 0x8E,  4},
           {(void*)&CO_OD_RAM.trace[0].value, 0x86,  4},
           {(void*)&CO_OD_RAM.trace[0].min, 0x86,  4},
           {(void*)&CO_OD_RAM.trace[0].max, 0x86,  4},
           {(void*)&CO_OD_RAM.trace[0].plot[0], 0x06,  1},
           {(void*)&CO_OD_RAM.trace[0].triggerTime, 0x8E,  4}};
