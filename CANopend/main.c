/*
 * CANopen main program file for SC243 microcontroller.
 *
 * @file        main_SC2x3.c
 * @version     SVN: \$Id$
...
int main (void){
    ...
    if(   CgiLog_init_1(CgiLog, SRAM.emcyBufPtr, SRAM.emcyBufSize, CgiCANLogBuf0,
       ...
       || CgiSend_init_1(CgiSend, CgiSendBuf, CgiSendBufSize))
    {
